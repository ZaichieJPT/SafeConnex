...
class AgencyAccidentScore extends StatefulWidget {
  const AgencyAccidentScore({super.key});

  @override
  State<AgencyAccidentScore> createState() => _AgencyAccidentScoreState();
}

class _AgencyAccidentScoreState extends State<AgencyAccidentScore> {
