...
class AgencyCancelledPage extends StatefulWidget {
  const AgencyCancelledPage({super.key});

  @override
  State<AgencyCancelledPage> createState() => _AgencyCancelledPageState();
}

class _AgencyCancelledPageState extends State<AgencyCancelledPage> {
